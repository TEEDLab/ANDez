#################################
# ANDez is a code set for author name disambiguation in Python 3
# This code set has been developed under an NSF grant: XXX
#
# Author:
# 1. Jinseok Kim: Institute for Research on Innovation & Science, Survey Research Center, School of Information, University of Michian Ann Arbor
# 2. Jenna Kim: School of Information Sciences, University of Illinois at Urbana-Champaign
# 3. Jason Owen-Smith: Institute for Research on Innovation & Science, Survey Research Center, Department of Sociology, University of Michigan
#
# This code set can be used under CC-BY-0
# If you use this code set for research, please cite the paper below
# 
#
#
#
...
train_instance_file = '../data/signatures_train.txt'
train_cluster_file  = '../data/clusters_train.txt'
train_record_file   = '../data/records.txt'

test_instance_file  = '../data/signatures_test.txt'
test_cluster_file   = '../data/clusters_test.txt'
test_record_file    = '../data/records.txt'
